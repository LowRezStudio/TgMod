...
defaultproperties
{
    // Reference: FogVolumeLinearHalfspaceDensityComponent'Engine.Default__FogVolumeLinearHalfspaceDensityInfo.FogVolumeComponent0'
    // TemplateOwnerClass: none
    // TemplateOwnerName: 'FogVolumeComponent0'
    begin object name="FogVolumeComponent0" class=Engine.FogVolumeLinearHalfspaceDensityComponent
    end object
    DensityComponent=FogVolumeComponent0
    // Reference: StaticMeshComponent'Engine.Default__FogVolumeLinearHalfspaceDensityInfo.AutomaticMeshComponent0'
    // TemplateOwnerClass: none
