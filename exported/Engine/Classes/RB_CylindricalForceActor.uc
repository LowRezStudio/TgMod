...
simulated function OnToggle(SeqAct_Toggle inAction)
{
    ...
    SetForcedInitialReplicatedProperty(BoolProperty'Engine.RB_CylindricalForceActor.bForceActive', bForceActive == default.bForceActive);
    //return;    
}

defaultproperties
{
    // Reference: DrawCylinderComponent'Engine.Default__RB_CylindricalForceActor.DrawCylinder0'
    // TemplateOwnerClass: none
    // TemplateOwnerName: 'DrawCylinder0'
    begin object name="DrawCylinder0" class=Engine.DrawCylinderComponent
