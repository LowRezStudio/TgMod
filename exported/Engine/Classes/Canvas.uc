...
struct native DepthFieldGlowInfo
{
    ...
    {
        bEnableGlow=false
        GlowColor=(R=0.0000000,G=0.0000000,B=0.0000000,A=1.0000000)
        GlowOuterRadius=(X=0.0000000,Y=0.0000000)
        GlowInnerRadius=(X=0.0000000,Y=0.0000000)
    }
};
...
struct native MobileDistanceFieldParams
{
    ...
    {
        Gamma=0.0000000
        AlphaRefVal=0.0000000
        SmoothWidth=0.0000000
        EnableShadow=false
        ShadowDirection=(X=0.0000000,Y=0.0000000)
        ShadowColor=(R=0.0000000,G=0.0000000,B=0.0000000,A=1.0000000)
        ShadowSmoothWidth=0.0000000
        BlendMode=0
    }
};
...
struct native FontRenderInfo
{
    ...
    structdefaultproperties
    {
        bClipText=false
        bEnableShadow=false
        GlowInfo=(bEnableGlow=false,GlowColor=(R=0.0000000,G=0.0000000,B=0.0000000,A=1.0000000),GlowOuterRadius=(X=0.0000000,Y=0.0000000),GlowInnerRadius=(X=0.0000000,Y=0.0000000))
    }
};
...
struct native CanvasUVTri
{
    ...
    structdefaultproperties
    {
        V0_Pos=(X=0.0000000,Y=0.0000000)
        V0_UV=(X=0.0000000,Y=0.0000000)
        V1_Pos=(X=0.0000000,Y=0.0000000)
        V1_UV=(X=0.0000000,Y=0.0000000)
        V2_Pos=(X=0.0000000,Y=0.0000000)
        V2_UV=(X=0.0000000,Y=0.0000000)
    }
};
...
struct native transient TextSizingParameters
{
    ...
    structdefaultproperties
    {
        ...
        DrawXL=0.0000000
        DrawYL=0.0000000
        Scaling=(X=0.0000000,Y=0.0000000)
        DrawFont=none
        SpacingAdjust=(X=0.0000000,Y=0.0000000)
        ViewportHeight=0.0000000
    }
};
...
struct native transient WrappedStringElement
{
    ...
    {
        Value=""
        LineExtent=(X=0.0000000,Y=0.0000000)
    }
};
...
native final function DrawRotatedTile(Texture Tex, Rotator Rotation, float XL, float YL, float U, float V, float UL, float VL, optional float AnchorX = 0.5000000, optional float AnchorY = 0.5000000, optional Canvas.EDisplayPlane DisplayPlane = 0);

// Export UCanvas::execDrawRotatedMaterialTile(FFrame&, void* const)
native final function DrawRotatedMaterialTile(MaterialInterface Mat, Rotator Rotation, float XL, float YL, optional float U = 0.0000000, optional float V = 0.0000000, optional float UL = 0.0000000, optional float VL = 0.0000000, optional float AnchorX = 0.5000000, optional float AnchorY = 0.5000000, optional Canvas.EDisplayPlane DisplayPlane = 0);
...
static final function FontRenderInfo CreateFontRenderInfo(optional bool bClipText, optional bool bEnableShadow, optional LinearColor GlowColor, optional Vector2D GlowOuterRadius, optional Vector2D GlowInnerRadius)
{
    ...
    Result.GlowInfo.bEnableGlow = GlowColor.A != 0.0000000;
    // End:0x14E
...
native final function TextSize(coerce string String, out float XL, out float YL, optional float XScale = 1.0000000, optional float YScale = 1.0000000);

// Export UCanvas::execDrawText(FFrame&, void* const)
native final function DrawText(coerce string Text, optional bool CR = true, optional float XScale = 1.0000000, optional float YScale = 1.0000000, const optional out FontRenderInfo RenderInfo, optional Canvas.EDisplayPlane DisplayPlane = 0);
...
native final function SetPos(float PosX, float PosY, optional float PosZ = 0.0000000);
...
final function DrawTexture(Texture Tex, float Scale, optional Canvas.EDisplayPlane DisplayPlane = 0)
{
    ...
    if(Tex != none)
    {
        TempColor.R = float(DrawColor.R) / 255.0000000;
        TempColor.G = float(DrawColor.G) / 255.0000000;
        TempColor.B = float(DrawColor.B) / 255.0000000;
        TempColor.A = float(DrawColor.A) / 255.0000000;
        DrawTile(Tex, Tex.GetSurfaceWidth() * Scale, Tex.GetSurfaceHeight() * Scale, 0.0000000, 0.0000000, Tex.GetSurfaceWidth(), Tex.GetSurfaceHeight(), TempColor, false, 2, DisplayPlane);
    }
    //return;    
}

// Export UCanvas::execDrawBlendedTile(FFrame&, void* const)
native final function DrawBlendedTile(Texture Tex, float XL, float YL, float U, float V, float UL, float VL, Canvas.ECanvasBlendMode Blend, optional Canvas.EDisplayPlane DisplayPlane = 0);
...
final function CanvasIcon MakeIcon(Texture Texture, optional float U, optional float V, optional float UL, optional float VL)
{
    ...
    if(Texture != none)
    {
        ...
        Icon.U = U;
        Icon.V = V;
        Icon.UL = ((UL != 0.0000000) ? UL : Texture.GetSurfaceWidth());
        Icon.VL = ((VL != 0.0000000) ? VL : Texture.GetSurfaceHeight());
    }
    return Icon;
    //return ReturnValue;    
}

final function DrawScaledIcon(CanvasIcon Icon, float X, float Y, Vector Scale, optional Canvas.EDisplayPlane DisplayPlane = 0)
{
    local LinearColor TempColor;
    ...
    {
        // End:0x81
        if(VSize(Scale) <= 0.0000000)
        {
            Scale.X = 1.0000000;
            Scale.Y = 1.0000000;
        }
        // End:0xF6
        if(Icon.UL == 0.0000000)
        {
            Icon.UL = Icon.Texture.GetSurfaceWidth();
        }
        // End:0x16B
        if(Icon.VL == 0.0000000)
        {
...
final function DrawIcon(CanvasIcon Icon, float X, float Y, optional float Scale, optional Canvas.EDisplayPlane DisplayPlane = 0)
{
    local LinearColor TempColor;
...
final function DrawRect(float RectX, float RectY, optional Texture Tex = DefaultTexture, optional Canvas.EDisplayPlane DisplayPlane = 0)
{
    local LinearColor TempColor;
    ...
    TempColor.B = float(DrawColor.B) / 255.0000000;
    TempColor.A = float(DrawColor.A) / 255.0000000;
    DrawTile(Tex, RectX, RectY, 0.0000000, 0.0000000, Tex.GetSurfaceWidth(), Tex.GetSurfaceHeight(), TempColor, false, 2, DisplayPlane);
    //return;    
}
