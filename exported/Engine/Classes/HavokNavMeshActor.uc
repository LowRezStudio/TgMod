...
struct native NavMeshLayerInfo
{
    var name Desc;
    var float Radius;
    var float Height;
...
struct native UserEdgeData
{
    ...
    structdefaultproperties
    {
        StartA=(X=0.0000000,Y=0.0000000,Z=0.0000000)
        EndA=(X=0.0000000,Y=0.0000000,Z=0.0000000)
        StartB=(X=0.0000000,Y=0.0000000,Z=0.0000000)
        EndB=(X=0.0000000,Y=0.0000000,Z=0.0000000)
        TraversalType=0
        EdgeCost=0.0000000
    }
};
...
// Export UHavokNavMeshActor::execInitializeNavMesh(FFrame&, void* const)
native function InitializeNavMesh();

// Export UHavokNavMeshActor::execCleanupNavMesh(FFrame&, void* const)
native function CleanupNavMesh();
...
defaultproperties
{
    ...
    Version=EHavokVersion.HAVOK_2014_2
