...
var native const transient map{VOID,VOID} AxisEmulationDefinitions;
...
static final function LocalPlayer GetLocalPlayer(int PlayerIndex)
{
    ...
    CurrentUIController = Class'Engine.UIRoot'.static.GetCurrentUIController();
    // End:0xFE
...
static final event bool IsLoggedIn(int ControllerId, optional bool bRequireOnlineLogin)
{
    ...
    bResult = (int(LoginStatus) == int(2)) || (int(LoginStatus) == int(1)) && !bRequireOnlineLogin;
    return bResult;
    //return ReturnValue;    
}
...
defaultproperties
{
    ...
    UIJoystickDeadZone=0.8000000
    UIAxisMultiplier=1.0000000
    AxisRepeatDelay=0.2000000
    MouseButtonRepeatDelay=0.1500000
    DoubleClickTriggerSeconds=0.5000000
    ...
    AxisInputEmulation[0]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    ...
    AxisInputEmulation[4]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[5]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[6]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[7]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[8]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[9]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[10]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[11]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[12]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[13]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[14]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[15]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[16]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[17]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[18]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[19]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[20]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[21]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[22]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
    AxisInputEmulation[23]=(bEnabled=true,CurrentRepeatKey="None",NextRepeatTime=())
}