...
// Export UTgSilhouetteComponent::execSetEnabled(FFrame&, void* const)
native function SetEnabled(bool bInEnabled);

// Export UTgSilhouetteComponent::execSetNegative(FFrame&, void* const)
native function SetNegative(bool bNegative);

// Export UTgSilhouetteComponent::execSetDistance(FFrame&, void* const)
native function SetDistance(float InNearDistance, float InFarDistance);
...
defaultproperties
{
    ...
    DepthPriorityGroup=ESceneDepthPriorityGroup.SDPG_Middleground
}