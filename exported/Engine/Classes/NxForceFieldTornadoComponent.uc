...
defaultproperties
{
    ...
    // Reference: ForceFieldShapeCapsule'Engine.Default__NxForceFieldTornadoComponent.Shape0'
    begin object name="Shape0" class=Engine.ForceFieldShapeCapsule
        // Reference: DrawCapsuleComponent'Engine.Default__NxForceFieldTornadoComponent.Shape0.DrawCapsule0'
