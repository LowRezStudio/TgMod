...
// Export UTgPawn_Buck::execModifyAccuracyForReticleBloom(FFrame&, void* const)
...
simulated function string GetAnimSetString(TgObject.EMountType MountType)
{
    switch(MountType)
    {
        // End:0x48
        case 1:
            return "PC_Warrior.Anims.AS_PC_Warrior_3p_Mount_Horse";
        // End:0xFFFF
        default:
            return "";
            break;
...
defaultproperties
{
    // Reference: TgCustomCharacterComponent'TgGame.Default__TgPawn_Buck.CustomCharacterInfo'
    ...
    // Reference: CylinderComponent'TgGame.Default__TgPawn_Buck.MountedCollision'
    // TemplateOwnerClass: none
    ...
    m_sGameplayPackage="Buck"
    // Reference: DynamicLightEnvironmentComponent'TgGame.Default__TgPawn_Buck.MyLightEnvironment'
    // TemplateOwnerClass: none
    ...
    // Reference: TgDropShadowDecalComponent'TgGame.Default__TgPawn_Buck.ShadowDecal'
    // TemplateOwnerClass: none
    ...
    // Reference: TgManifestGroup'TgGame.Default__TgPawn_Buck.TgManifestGroup0'
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Buck.TakeHitAC'
    // TemplateOwnerClass: none
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Buck.PainAC'
    // TemplateOwnerClass: none
    ...
    r_fLeapAirControl=1.5000000
    m_fBaseLeapAirControl=1.5000000
    BaseEyeHeight=60.0000000
    EyeHeight=60.0000000
    // Reference: CylinderComponent'TgGame.Default__TgPawn_Buck.CollisionCylinder'
    // TemplateOwnerClass: none
    ...
    Components[5]=PainAC
    // Reference: PComPositionHistoryComponent'TgGame.Default__TgPawn_Buck.PositionHistoryComponent'
