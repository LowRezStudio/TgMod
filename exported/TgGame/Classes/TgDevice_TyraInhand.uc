...
// Export UTgDevice_TyraInhand::execCheckAutoReload(FFrame&, void* const)
native function bool CheckAutoReload();

// Export UTgDevice_TyraInhand::execRequiresAmmoToFire(FFrame&, void* const)
native function bool RequiresAmmoToFire();

// Export UTgDevice_TyraInhand::execShouldShowAmmoCount(FFrame&, void* const)
...
defaultproperties
{
    ...
    m_WeaponMeshActorClass=Class'TgGame.TgWeaponMeshActor_TyraInhand'
    m_GameplayCurvesDeprecated=TgGameplayCurves'GP_Tyra.DeviceInhand'
