...
simulated function string GetAnimSetString(TgObject.EMountType MountType)
{
    switch(MountType)
    {
        // End:0x51
        case 1:
            return "PC_Salty_Skin00A.Anims.AS_PC_Salty_Skin00A_Mount_Horse";
        // End:0xFFFF
        default:
            return "";
            break;
...
defaultproperties
{
    ...
    // Reference: TgCustomCharacterComponent'TgGame.Default__TgPawn_Tyra.CustomCharacterInfo'
    ...
    // Reference: CylinderComponent'TgGame.Default__TgPawn_Tyra.MountedCollision'
    // TemplateOwnerClass: none
    ...
    m_bUsesRecoil=true
    m_sGameplayPackage="Tyra"
    // Reference: DynamicLightEnvironmentComponent'TgGame.Default__TgPawn_Tyra.MyLightEnvironment'
    // TemplateOwnerClass: none
    ...
    // Reference: TgDropShadowDecalComponent'TgGame.Default__TgPawn_Tyra.ShadowDecal'
    // TemplateOwnerClass: none
    ...
    // Reference: TgManifestGroup'TgGame.Default__TgPawn_Tyra.TgManifestGroup0'
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Tyra.TakeHitAC'
    // TemplateOwnerClass: none
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Tyra.PainAC'
    // TemplateOwnerClass: none
    ...
    // Reference: CylinderComponent'TgGame.Default__TgPawn_Tyra.CollisionCylinder'
    // TemplateOwnerClass: none
    ...
    Components[5]=PainAC
    // Reference: PComPositionHistoryComponent'TgGame.Default__TgPawn_Tyra.PositionHistoryComponent'
