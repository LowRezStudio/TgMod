...
{
    m_FatalityMeshActor = Spawn(Class'TgGame.TgFatalityMeshActor', self,,,,, true);
    m_FatalityMeshActor.Initialize(MeshAsmId, 1);
    m_FatalityMeshActor.m_Mesh.SetLightingChannels(m_LightingChannels);
    //return;    
}
