class TgSeqAct_TgCameraShake extends SequenceAction
    forcescriptorder(true)
    hidecategories(Object);

var() TgCameraShake m_CameraShake;
var Actor m_LocationActor;
...
defaultproperties
{
    ...
    VariableLinks[1]=(ExpectedType=Class'Engine.SeqVar_Object',LinkedVariables=none,LinkDesc="Location",LinkVar="None",PropertyName="m_LocationActor",bWriteable=false,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=none,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false)
    ObjName="Tg Camera Shake"
}