class TgPawn_Tower_Outer extends TgPawn_Tower_FA
    config(Game)
    hidecategories(Navigation);

defaultproperties
{
    m_TowerType=ETowerType.TowerType_Outer
    // Reference: TgMarkComponent'TgGame.Default__TgPawn_Tower_Outer.TowerDamageScaler'
    ...
    // Reference: DynamicLightEnvironmentComponent'TgGame.Default__TgPawn_Tower_Outer.MyLightEnvironment'
    // TemplateOwnerClass: none
    ...
    // Reference: TgDropShadowDecalComponent'TgGame.Default__TgPawn_Tower_Outer.ShadowDecal'
    // TemplateOwnerClass: none
    ...
    // Reference: TgManifestGroup'TgGame.Default__TgPawn_Tower_Outer.TgManifestGroup0'
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Tower_Outer.TakeHitAC'
    // TemplateOwnerClass: none
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Tower_Outer.PainAC'
    // TemplateOwnerClass: none
    ...
    // Reference: CylinderComponent'TgGame.Default__TgPawn_Tower_Outer.CollisionCylinder'
    // TemplateOwnerClass: none
    ...
    Components[5]=PainAC
    // Reference: PComPositionHistoryComponent'TgGame.Default__TgPawn_Tower_Outer.PositionHistoryComponent'
