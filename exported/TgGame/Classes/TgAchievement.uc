...
// Export UTgAchievement::execGetCustomValue1(FFrame&, void* const)
native function float GetCustomValue1();

// Export UTgAchievement::execGetCustomValue2(FFrame&, void* const)
native function float GetCustomValue2();

// Export UTgAchievement::execGetCustomValue3(FFrame&, void* const)
native function float GetCustomValue3();

// Export UTgAchievement::execGetCustomValue4(FFrame&, void* const)
native function float GetCustomValue4();

// Export UTgAchievement::execGetCustomValue5(FFrame&, void* const)
native function float GetCustomValue5();

// Export UTgAchievement::execBelongsToBot(FFrame&, void* const)
native function bool BelongsToBot(int BotId);

// Export UTgAchievement::execStopTracking(FFrame&, void* const)
native function StopTracking();
