...
// Export UTgGame_Battle_Casual::execGetRespawnTime(FFrame&, void* const)
native function float GetRespawnTime(int TaskForceNum);

// Export UTgGame_Battle_Casual::execShouldSpawnSuperMinions(FFrame&, void* const)
native function bool ShouldSpawnSuperMinions(TgBotFactory_Minions minionFactory);

// Export UTgGame_Battle_Casual::execStructureDied(FFrame&, void* const)
...
defaultproperties
{
    ...
    m_GameType=TG_GAME_TYPE.TGT_BATTLE_CASUAL
}