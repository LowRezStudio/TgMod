...
// Export UTgPawn_SiegeWall_Outer::execSendAttackAlert(FFrame&, void* const)
...
simulated function PostBeginPlay()
{
    ...
    if(int(Role) == int(ROLE_Authority))
    {
        ...
        if(ChaosGame != none)
        {
            ((int(GetTaskForceNumber()) == int(1)) ? ChaosGame.m_TF1OuterWall == self : ChaosGame.m_TF2OuterWall == self);
        }
    }
    //return;    
}
...
{
    return ((int(GetTaskForceNumber()) == int(1)) ? 'TF1_DoorOuter_Hit' : 'TF2_DoorOuter_Hit');
    //return ReturnValue;    
}

event int GetHPScalingValue()
{
    return TgGame_PaladinsExtended(WorldInfo.Game).m_nOuterGateHPScaling;
    //return ReturnValue;    
}
...
event RegisterWithGRI()
{
    ...
    if(GRI != none)
    {
        ...
        {
            GRI.r_pSiegeWallTF1[0] = self;            
        }
        else
        {
            GRI.r_pSiegeWallTF2[0] = self;
        }
    }
    //return;    
}
...
function UnRegisterWithGRI()
{
    ...
    if(GRI != none)
    {
        ...
        if(int(GetTaskForceNumber()) == int(1))
        {
            GRI.r_pSiegeWallTF1[0] = none;            
        }
        else
        {
            GRI.r_pSiegeWallTF2[0] = none;
        }
    }
    //return;    
}
...
defaultproperties
{
    // Reference: TgMarkComponent'TgGame.Default__TgPawn_SiegeWall_Outer.TowerDamageScaler'
    ...
    // Reference: DynamicLightEnvironmentComponent'TgGame.Default__TgPawn_SiegeWall_Outer.MyLightEnvironment'
    // TemplateOwnerClass: none
    ...
    // Reference: TgDropShadowDecalComponent'TgGame.Default__TgPawn_SiegeWall_Outer.ShadowDecal'
    // TemplateOwnerClass: none
    ...
    // Reference: TgManifestGroup'TgGame.Default__TgPawn_SiegeWall_Outer.TgManifestGroup0'
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_SiegeWall_Outer.TakeHitAC'
    // TemplateOwnerClass: none
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_SiegeWall_Outer.PainAC'
    // TemplateOwnerClass: none
    ...
    // Reference: CylinderComponent'TgGame.Default__TgPawn_SiegeWall_Outer.CollisionCylinder'
    // TemplateOwnerClass: none
    ...
    Components[5]=PainAC
    // Reference: PComPositionHistoryComponent'TgGame.Default__TgPawn_SiegeWall_Outer.PositionHistoryComponent'
    ...
    // Reference: StaticMeshComponent'TgGame.Default__TgPawn_SiegeWall_Outer.CollisionMesh'
    // TemplateOwnerClass: none
