class TgPawn_Tower_Inner extends TgPawn_Tower_FA
    config(Game)
    hidecategories(Navigation);

defaultproperties
{
    m_TowerType=ETowerType.TowerType_Inner
    // Reference: TgMarkComponent'TgGame.Default__TgPawn_Tower_Inner.TowerDamageScaler'
    ...
    // Reference: DynamicLightEnvironmentComponent'TgGame.Default__TgPawn_Tower_Inner.MyLightEnvironment'
    // TemplateOwnerClass: none
    ...
    // Reference: TgDropShadowDecalComponent'TgGame.Default__TgPawn_Tower_Inner.ShadowDecal'
    // TemplateOwnerClass: none
    ...
    // Reference: TgManifestGroup'TgGame.Default__TgPawn_Tower_Inner.TgManifestGroup0'
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Tower_Inner.TakeHitAC'
    // TemplateOwnerClass: none
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Tower_Inner.PainAC'
    // TemplateOwnerClass: none
    ...
    // Reference: CylinderComponent'TgGame.Default__TgPawn_Tower_Inner.CollisionCylinder'
    // TemplateOwnerClass: none
    ...
    Components[5]=PainAC
    // Reference: PComPositionHistoryComponent'TgGame.Default__TgPawn_Tower_Inner.PositionHistoryComponent'
