class TgPawn_Turret_Flamethrower extends TgPawn_Turret
    native(Pawns)
    config(Game)
...
defaultproperties
{
    // Reference: DynamicLightEnvironmentComponent'TgGame.Default__TgPawn_Turret_Flamethrower.MyLightEnvironment'
    ...
    // Reference: TgDropShadowDecalComponent'TgGame.Default__TgPawn_Turret_Flamethrower.ShadowDecal'
    // TemplateOwnerClass: none
    ...
    // Reference: TgManifestGroup'TgGame.Default__TgPawn_Turret_Flamethrower.TgManifestGroup0'
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Turret_Flamethrower.TakeHitAC'
    // TemplateOwnerClass: none
    ...
    // Reference: AudioComponent'TgGame.Default__TgPawn_Turret_Flamethrower.PainAC'
    // TemplateOwnerClass: none
    ...
    m_nSuccessfulHitSpecialFXId=6977
    // Reference: CylinderComponent'TgGame.Default__TgPawn_Turret_Flamethrower.CollisionCylinder'
    // TemplateOwnerClass: none
    ...
    Components[5]=PainAC
    // Reference: PComPositionHistoryComponent'TgGame.Default__TgPawn_Turret_Flamethrower.PositionHistoryComponent'
