...
simulated function UpdateTransform(float DeltaTime, optional bool bFromCameraUpdate = false)
{
    ...
    if(m_WeaponMesh1P != none)
    {
        ...
        if(HasCachedDemon())
        {
            m_CachedDemon.m_CurrentDOFSettings.IsActive = fZoomPct > 0.0000000;
            m_CachedDemon.m_CurrentDOFSettings.MaxNearBlurAmount = fZoomPct;
        }
...
defaultproperties
{
    ...
    // Reference: TgCameraShake'TgGame.Default__TgWeaponMeshActor_DemonInhand.CameraShake'
