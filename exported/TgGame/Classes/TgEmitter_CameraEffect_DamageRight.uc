class TgEmitter_CameraEffect_DamageRight extends TgEmitter_CameraEffect_DamageBase
    hidecategories(Navigation);

defaultproperties
{
    // Reference: ParticleSystemComponent'TgGame.Default__TgEmitter_CameraEffect_DamageRight.ParticleSystemComponent0'
