...
// Export UTgEffect::execCloneEffect(FFrame&, void* const)
native function TgEffect CloneEffect();

// Export UTgEffect::execCanBeApplied(FFrame&, void* const)
native function bool CanBeApplied(Actor Target);

// Export UTgEffect::execSetProperty(FFrame&, void* const)
native function SetProperty(Actor Target, int nPropertyId, float fNewValue);

// Export UTgEffect::execApplyEffect(FFrame&, void* const)
native function bool ApplyEffect(Actor Target, optional ImpactInfo Impact, optional bool bLatent);

// Export UTgEffect::execApplyStacks(FFrame&, void* const)
native function bool ApplyStacks(Actor Target, int nNumStacks);

// Export UTgEffect::execRemoveStacks(FFrame&, void* const)
native function bool RemoveStacks(Actor Target, int nNumStacks);

// Export UTgEffect::execApplyToProperty(FFrame&, void* const)
native function ApplyToProperty(Actor Target, int nPropertyId, float fProratedAmount, optional bool bRemove = false);

// Export UTgEffect::execGetProratedValue(FFrame&, void* const)
native function float GetProratedValue();

// Export UTgEffect::execReapply(FFrame&, void* const)
native function Reapply(Actor Target);

// Export UTgEffect::execRemove(FFrame&, void* const)
native function Remove(Actor Target, optional bool bResetToFollow);

// Export UTgEffect::execTrackStats(FFrame&, void* const)
native function TrackStats(TgPawn Instigator, Actor Target, ImpactInfo Impact, float fDamage, int iTargetDeviceModeId, bool bIsEnemy, optional float fMissingHealth = -1.0000000, optional float fMitigatedDamage = -1.0000000);

// Export UTgEffect::execGetTopMostDevice(FFrame&, void* const)
native function int GetTopMostDevice(TgDeviceFire devFire);

// Export UTgEffect::execApplyEnterCombatRules(FFrame&, void* const)
native function ApplyEnterCombatRules(Actor Instigator, Actor Target);

// Export UTgEffect::execGetTargetProperty(FFrame&, void* const)
native function TgProperty GetTargetProperty(Actor Target, int nPropertyId);

// Export UTgEffect::execGetDeviceIdFromMode(FFrame&, void* const)
native static function int GetDeviceIdFromMode(TgDeviceFire DeviceFireMode);
