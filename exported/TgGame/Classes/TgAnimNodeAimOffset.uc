...
defaultproperties
{
    m_PitchControlType=EPitchControlType.PITCHCONTROL_Legacy
    m_PitchControlUserCurve=(Points=((InVal=-17920.0000000,OutVal=-1.0000000,ArriveTangent=0.0000000,LeaveTangent=0.0000000,InterpMode=EInterpCurveMode.CIM_Linear),(InVal=17920.0000000,OutVal=1.0000000,ArriveTangent=0.0000000,LeaveTangent=0.0000000,InterpMode=EInterpCurveMode.CIM_Linear)),InterpMethod=EInterpMethodType.IMT_UseFixedTangentEval)
