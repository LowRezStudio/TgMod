...
//var delegate<DelegateEvent> __DelegateEvent__Delegate;
...
// Export UTgGfxScene::execReceiveEvent(FFrame&, void* const)
native function ReceiveEvent(GFxObject pObj, int nEvent);

final event Focus(GFxObject pObj)
{
    ActionScriptVoid("Focus");
    //return;    
}

final event Rollover(GFxObject pObj)
{
    ActionScriptVoid("Rollover");
    //return;    
}

final event Rollout(GFxObject pObj)
{
    ActionScriptVoid("Rollout");
    //return;    
}

final event Click(GFxObject pObj)
{
    ActionScriptVoid("Click");
    //return;    
}

// Export UTgGfxScene::execAnimate(FFrame&, void* const)
...
// Export UTgGfxScene::execCancelAnim(FFrame&, void* const)
native function CancelAnim(GFxObject pObj);

// Export UTgGfxScene::execEndAnim(FFrame&, void* const)
native function EndAnim(GFxObject pObj, UIComponent.UIANIMTYPE eType);

// Export UTgGfxScene::execIsAnimating(FFrame&, void* const)
native function bool IsAnimating(GFxObject pObj);

// Export UTgGfxScene::execIsAnimatingType(FFrame&, void* const)
native function bool IsAnimatingType(GFxObject pObj, UIComponent.UIANIMTYPE eType);

// Export UTgGfxScene::execFadeIn(FFrame&, void* const)
native function FadeIn(GFxObject pObj, optional float fTime = 0.1000000, optional float fDelay = 0.0000000);

// Export UTgGfxScene::execFadeOut(FFrame&, void* const)
native function FadeOut(GFxObject pObj, optional float fTime = 0.1000000, optional float fDelay = 0.0000000);

// Export UTgGfxScene::execHighlight(FFrame&, void* const)
native function Highlight(GFxObject pObj, bool bShow, optional float fTime = 0.1000000);

// Export UTgGfxScene::execSlamInAnim(FFrame&, void* const)
native function SlamInAnim(GFxObject pObj, optional float fDelay = 0.0000000);

// Export UTgGfxScene::execSlamOutAnim(FFrame&, void* const)
native function SlamOutAnim(GFxObject pObj, optional float fDelay = 0.0000000);
...
defaultproperties
{
    m_UISceneClass=Class'TgClient.UIScene'
    m_ePromptAlignment=UIALIGNINGTYPE.UIALIGNING_CENTER
    m_nHighlight=-1
    m_bInitData=true
    ...
    m_scShown=AkEvent'WW_UI_Default.UI_Menu_Panel_SlideIn_Play'
    m_scHighlight=AkEvent'WW_UI_Default.UI_Menu_Checkbox_Off_Play'
}