...
defaultproperties
{
    m_scDailyReward=AkEvent'WW_UI_Default.UI_Lobby_Alert_LevelUp_CharacterMastery_Play'
    m_scDailyRewardAccept=AkEvent'WW_UI_Default.UI_Menu_CardCraft_Finish_Play'
}