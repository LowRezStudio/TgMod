...
struct native AcquisitionCarouselItem
{
    ...
    {
        mcPurchaseItem=none
        mcPurchaseChest=none
        mcPurchaseCard=none
        mcPurchaseItemDisplay=none
        mcPurchaseItemIcon=none
        mcPurchaseItemCardIcon=none
        mcPurchaseItemCurrency=none
        mcPurchaseItemRarityFrame=none
        mcPurchaseItemRarityText=none
        mcPurchaseItemTypeIcon=none
        mcPurchaseItemTitle=none
        mcPurchaseItemSubtitle=none
        mcPurchaseItemChampion=none
        mcPurchaseItemChampionIcon=none
        mcPurchaseItemChampionLarge=none
        mcPurchaseItemChampionTitle=none
        mcPurchaseItemChampionImage=none
        mcPurchaseItemAudio=none
    }
};
