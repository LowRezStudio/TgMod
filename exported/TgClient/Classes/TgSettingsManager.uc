...
struct native TgKeyBind
{
    var native Pointer pCommand;
    var bool bOverrides;
...
struct native TgSettingsSet
{
    var init array<init TgKeyBind> Keybinds;
    var native Pointer CaseSet;
...
var native map{VOID,VOID} m_Sets;
var array<TgSetting> m_Settings;
var const array<TgKeyCommand> m_Commands;

// Export UTgSettingsManager::execGetKeybindExtended(FFrame&, void* const)
native exec function string GetKeybindExtended(string sCommand, int nAlt, optional int nBotId = -1);
