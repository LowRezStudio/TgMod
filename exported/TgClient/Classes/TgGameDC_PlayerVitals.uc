...
// Export UTgGameDC_PlayerVitals::execInitializeData(FFrame&, void* const)
native function InitializeData(TgDataHandler Handler, TgDataChunk parentChunk);

// Export UTgGameDC_PlayerVitals::execNotifyMapChange(FFrame&, void* const)
native function NotifyMapChange();

// Export UTgGameDC_PlayerVitals::execUpdateDamageDone(FFrame&, void* const)
native function UpdateDamageDone();

// Export UTgGameDC_PlayerVitals::execUpdateCoreStats(FFrame&, void* const)
native function UpdateCoreStats();
