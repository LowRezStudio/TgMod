...
defaultproperties
{
    ...
    m_akShown=AkEvent'WW_UI_Default.UI_Lobby_MatchFound_Play'
    m_akSelect=AkEvent'WW_UI_Default.UI_Lobby_MatchInvite_PlayerJoin_Play'
    m_QueuePopWaveform=ForceFeedbackWaveform'gp_forcefeedback.QueuePopForceFeedback'
