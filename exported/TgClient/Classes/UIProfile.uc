...
struct native UIAwardData
{
    ...
    structdefaultproperties
    {
        ...
        nGoalCount=0
        nGoalGroup=0
        Goals[0]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[1]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[2]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[3]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[4]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[5]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[6]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[7]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[8]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
        Goals[9]=(nDate=0,nGoal=0,nValue=0,nProgress=0,nDisplayId=0,nGoalProgress=0,bCompleted=false,sDate="",sDesc="",sTier="",sTitle="",sSource="")
    }
};

struct native UIHistoryData
{
    var int nId;
    var int nClass;
    var init string sDate;
    ...
    structdefaultproperties
    {
        ...
        sMode=""
        sScore=""
        eResult=EHistoryResult.EHR_WIN
        sDuration=""
        dtEvent=(qTime=())
    }
};
...
defaultproperties
{
    ...
    m_UISceneClass=Class'TgClient.UIScene_UIProfile'
    m_OptionList[0]=14
    m_OptionList[1]=4
    m_nBackground=1
