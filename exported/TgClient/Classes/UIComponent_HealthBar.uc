...
struct native BarTickTypes
{
    ...
    structdefaultproperties
    {
        ...
        sContainerName=""
        fWidth=0.0000000
        eBorderTickType=EHealthTickType.EHTT_Health
        mcBorderTickMask=none
        mcLeftBorderTick=none
        mcRightBorderTick=none
    }
};
...
defaultproperties
{
    ...
    m_BarTickTypes[2]=(sMaskName="ShadowBorderTickMask",sContainerName="ShadowBorderTickContainer",fWidth=0.0000000,eBorderTickType=EHealthTickType.EHTT_Shadow,mcBorderTickMask=none,mcLeftBorderTick=none,mcRightBorderTick=none)
