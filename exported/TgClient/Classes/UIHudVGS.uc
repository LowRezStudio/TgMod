...
//var delegate<usc_ForceInput_Delegate> __usc_ForceInput_Delegate__Delegate;
...
// Export UUIHudVGS::execusc_ForceInput(FFrame&, void* const)
native function usc_ForceInput(string Input);
