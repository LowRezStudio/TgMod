...
defaultproperties
{
    ...
    m_BarTickTypes[2]=(sMaskName="DamageBorderTickMask",sContainerName="DamageBorderTickContainer",fWidth=0.0000000,eBorderTickType=EHTT_Damage,mcBorderTickMask=none,mcLeftBorderTick=none,mcRightBorderTick=none)
    m_BarTickTypes[3]=(sMaskName="ShadowBorderTickMask",sContainerName="ShadowBorderTickContainer",fWidth=0.0000000,eBorderTickType=EHTT_Shadow,mcBorderTickMask=none,mcLeftBorderTick=none,mcRightBorderTick=none)
