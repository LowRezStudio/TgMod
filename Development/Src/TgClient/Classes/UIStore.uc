...
struct UIStoreFoundersPackPanel {
    var GFxObject Obj;
    var GFxObject Title;
...
native function OnTeamModelUpdated();  // Export UUIStore::execOnTeamModelUpdated(FFrame&, void* const)
...
defaultproperties
{
    ...
    m_DefaultStoreFilter=(eCurrentSorting=SSORT_Default,eCurrentChampionFilter=CFILTER_All,nIndividuallyFilteredBotId=2092,bAvailable=true,bNotOwned=true,nRarityFilter=1,nRarityFilter[1]=1,nRarityFilter[2]=1,nRarityFilter[3]=1,nRarityFilter[4]=1)
    m_CurrentStoreFilter=(eCurrentSorting=SSORT_Default,eCurrentChampionFilter=CFILTER_All,nIndividuallyFilteredBotId=2092,bAvailable=true,bNotOwned=true,nRarityFilter=1,nRarityFilter[1]=1,nRarityFilter[2]=1,nRarityFilter[3]=1,nRarityFilter[4]=1)
    m_InProgressStoreFilter=(eCurrentSorting=SSORT_Default,eCurrentChampionFilter=CFILTER_All,nIndividuallyFilteredBotId=2092,bAvailable=true,bNotOwned=true,nRarityFilter=1,nRarityFilter[1]=1,nRarityFilter[2]=1,nRarityFilter[3]=1,nRarityFilter[4]=1)
    m_UISceneClass=Class'UIScene_UIStore'
    m_OptionList[0]=14
    m_OptionList[1]=4
    m_OptionList[2]=0
    m_OptionList[3]=0
