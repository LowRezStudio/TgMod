...
defaultproperties
{
    ...
    m_eGoldPanelFieldIcons[2]=UIRBI_FWOTD1
    m_eGoldPanelFieldIcons[4]=UIRBI_PARTYOFF
    m_eGoldPanelFieldIcons[5]=UIRBI_ACCOUNTOFF
    m_eGoldPanelFieldIcons[6]=UIRBI_NETCAFE1
    m_eXPPanelFieldIcons[2]=UIRBI_PARTYOFF
    m_eXPPanelFieldIcons[3]=UIRBI_ACCOUNTOFF
    m_eXPPanelFieldIcons[4]=UIRBI_NETCAFE1
    ...
    m_scTick=SoundCue'A_CUE_UI_Notification_XPTick_Loop'
    m_scTickEnd=SoundCue'A_CUE_UI_Notification_XPTick_End'
    m_akLevelUp=AkEvent'UI_Lobby_Alert_LevelUp_AccountMastery_Play'
    m_akAccolade=AkEvent'UI_Menu_CardCraft_Finish_Play'
    m_akMasteryUp=AkEvent'UI_Lobby_Alert_LevelUp_CharacterMastery_Play'
    m_nPlayerToReport=-1
    m_UISceneClass=Class'UIScene_UIEndOfMatchLobby'
    m_OptionList[0]=9
    m_OptionList[1]=4
    m_OptionList[2]=0
    m_bBlur=true
