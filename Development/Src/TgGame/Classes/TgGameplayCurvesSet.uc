...
native function float GetDistributionValue(const out RawDistributionFloat Distribution, float T);  // Export UTgGameplayCurvesSet::execGetDistributionValue(FFrame&, void* const)

native function bool GetPrimaryDistributionValue(float T, out float Value);  // Export UTgGameplayCurvesSet::execGetPrimaryDistributionValue(FFrame&, void* const)
