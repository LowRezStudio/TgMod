...
native function Spin(bool bEnabled);  // Export UTgSkelCon_Spinner::execSpin(FFrame&, void* const)

native function SpinToTargetRotation(Rotator TargetRotation, optional float Time, optional bool bReset);  // Export UTgSkelCon_Spinner::execSpinToTargetRotation(FFrame&, void* const)
