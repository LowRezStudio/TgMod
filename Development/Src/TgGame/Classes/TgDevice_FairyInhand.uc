class TgDevice_FairyInhand extends TgDevice
    native(ChampFairy)
    hidecategories(Navigation)
    config(Engine);

native function DeviceAdjustDamage(const out ImpactInfo Impact, out float fDamage, int nPropertyId);  // Export UTgDevice_FairyInhand::execDeviceAdjustDamage(FFrame&, void* const)
...
defaultproperties
{
    ...
    m_WeaponMeshActorClass=Class'TgWeaponMeshActor_IceStaff'
