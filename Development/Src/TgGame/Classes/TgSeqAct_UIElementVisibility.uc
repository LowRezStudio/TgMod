...
defaultproperties
{
    ...
    VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Bool',LinkDesc="Show?",LinkVar="None",PropertyName="ShowElement",bWriteable=false,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=none,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false)
    ...
    VariableLinks(3)=(ExpectedType=Class'Engine.SeqVar_String',LinkDesc="UI Element Name",LinkVar="None",PropertyName="UIElementName",bWriteable=false,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=none,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false)
