...
native function TurnTargetToOwner();  // Export UTgDevice_Rush::execTurnTargetToOwner(FFrame&, void* const)

native function bool PredictChargeInterrupt(Vector StartLocation, Vector endLocation);  // Export UTgDevice_Rush::execPredictChargeInterrupt(FFrame&, void* const)

native function MoveTargetToSafeArea(TgPawn pPawnTarget);  // Export UTgDevice_Rush::execMoveTargetToSafeArea(FFrame&, void* const)
