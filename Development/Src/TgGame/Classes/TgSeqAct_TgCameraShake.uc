...
defaultproperties
{
    ...
    VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="Location",LinkVar="None",PropertyName="m_LocationActor",bWriteable=false,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=none,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false)
