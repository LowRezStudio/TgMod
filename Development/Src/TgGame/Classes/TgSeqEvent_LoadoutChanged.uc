...
function bool TriggerGlobal(Actor InInstigator, int InDeckIndex) { }
...
defaultproperties
{
    ...
    VariableLinks[1]=(ExpectedType=Class'SeqVar_Int',LinkedVariables=none,LinkDesc="Deck Index",LinkVar="None",PropertyName="DeckIndex",bWriteable=true,bSequenceNeverReadsOnlyWritesToThisVar=false,bModifiesLinkedObject=false,bHidden=false,MinVars=1,MaxVars=255,DrawX=0,CachedProperty=none,bAllowAnyType=false,bMoving=false,bClampedMax=false,bClampedMin=false)
