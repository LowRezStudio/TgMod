...
struct ChargeHitInfo {
    var Actor HitActor;
    var float TimeStamp;
    structdefaultproperties {}
};

struct TgAbilityInfo {
...
native function TgPlayerController ScriptGetLocalTGPlayerController();  // Export UTgObject::execScriptGetLocalTGPlayerController(FFrame&, void* const)
