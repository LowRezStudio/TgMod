...
native function OnDeviceFormBuildup(TgDeviceForm DeviceForm, float BuildupTime);  // Export UTgAnimBlendByFire::execOnDeviceFormBuildup(FFrame&, void* const)

native function OnDeviceFormStartFire(TgDeviceForm DeviceForm, float FireDuration);  // Export UTgAnimBlendByFire::execOnDeviceFormStartFire(FFrame&, void* const)

native function OnDeviceFormStopFire(TgDeviceForm DeviceForm);  // Export UTgAnimBlendByFire::execOnDeviceFormStopFire(FFrame&, void* const)

native function OnDeviceFormInterruptFire(TgDeviceForm DeviceForm);  // Export UTgAnimBlendByFire::execOnDeviceFormInterruptFire(FFrame&, void* const)
