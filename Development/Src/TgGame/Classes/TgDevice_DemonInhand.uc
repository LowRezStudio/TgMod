...
native function bool CheckAutoReload();  // Export UTgDevice_DemonInhand::execCheckAutoReload(FFrame&, void* const)

native function bool RequiresAmmoToFire();  // Export UTgDevice_DemonInhand::execRequiresAmmoToFire(FFrame&, void* const)

native function bool ShouldShowAmmoCount();  // Export UTgDevice_DemonInhand::execShouldShowAmmoCount(FFrame&, void* const)
...
defaultproperties
{
    ...
    m_WeaponMeshActorClass=Class'TgWeaponMeshActor_DemonInhand'
